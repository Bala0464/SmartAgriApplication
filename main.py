    ...
    def save_images(self, instance):
        ...
        if plant_image_path and soil_image_path:
            ...
            for impath in mylist:
                ...
                if (max == n_pixels):
                    cv2.putText(image, f'potassium deficiency  :- {k:.2f}%', (0, 90), cv2.FONT_HERSHEY_TRIPLEX, 1,
                                (255, 255, 255), 1)
                    cv2.putText(image, f'phosphorus deficiency :- {p:.2f}%', (0, 40), cv2.FONT_HERSHEY_TRIPLEX, 1,
                                (255, 255, 255), 1)
                    cv2.imshow("Webcam Feed", image)
                    ...
                    cv2.putText(image, f'potassium deficiency :- {k:.2f}%', (0, 90), cv2.FONT_HERSHEY_TRIPLEX, 1,
                                (255, 255, 255), 1)
                    cv2.putText(image, f'nitrogen deficiency  :- {n:.2f}%', (0, 40), cv2.FONT_HERSHEY_TRIPLEX, 1,
                                (255, 255, 255), 1)
                    cv2.imshow("Webcam Feed", image)
                else:
                    cv2.putText(image, f'nitrogen deficiency   :- {n:.2f}%', (0, 90), cv2.FONT_HERSHEY_TRIPLEX, 1,
                                (255, 255, 255), 1)
                    cv2.putText(image, f'phosphorus deficiency :- {p:.2f}%', (0, 40), cv2.FONT_HERSHEY_TRIPLEX, 1,
                                (255, 255, 255), 1)
                    cv2.imshow("Webcam Feed", image)
